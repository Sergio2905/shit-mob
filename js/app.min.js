...
const projectsSlider = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"]('.projects__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_3__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_3__.EffectCreative],
    observer: true,
    observeParents: true,
    ...
    speed: 500,
    navigation: {
        prevEl: '.projects__navigation .navigation__prev',
        nextEl: '.projects__navigation .navigation__next',
        lockClass: 'lock',
...
const copyLink = (btn, e) => {
    var input = document.createElement('input');
    input.value = btn.dataset.link;
...
document.addEventListener('click', (e) => {
    const copyBtn = e.target.closest('.frens__copy');
    if (copyBtn) {
        copyLink(copyBtn, e);
    }

    const btn = e.target.closest('.btn, .btn-black, .header__btn, .wallets__link, .tasks__link');
    if (btn) {
        btnHover(btn);
    }

...
const projectsSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__["default"]('.projects__slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_2__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_2__.EffectCreative],
    observer: true,
    observeParents: true,
...
document.addEventListener('click', (e) => {
    ...
    const btn = e.target.closest('.btn, .btn-black, .header__btn');
    if (btn) {
        btnHover(btn);
    }
});
